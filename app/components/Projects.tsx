...
const projects: Project[] = [
  ...
  },
  {
    ...
    description:
      "Event-driven distributed monolith simulating an ecosystem of animals, plants, and weather patterns as the domain to generate big data and explore architectural patterns. Built with a polyglot stack (Go, Elixir, Python) communicating via Kafka, with Redis and PostgreSQL for state management, Docker for containerization, and Grafana for observability. A sandbox for testing out distributed systems concepts like event sourcing, CQRS, stream processing, and microservices vs monolith tradeoffs. Endgoal is a data platform architecture pattern showcase and a YouTube series documenting the design and development process.",
    year: "2026",
    skills: [
      "Go",
      "Elixir",
  ...
  },
  {
    ...
    description:
      "This site. A Winter Study aesthetic emphasizing readability, quiet sophistication, and warmth. Built as an expression of design philosophy as much as technical capability.",
    year: "2025",
