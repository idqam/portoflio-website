...
const projects: Project[] = [
  {
    ...
    description:
      "URL shortener built in Go with Redis caching, rate limiting, and structured observability — containerized with multi-stage Docker builds, deployed to Kubernetes with HPA, and monitored end-to-end with Prometheus, Grafana, and distributed tracing.",
    year: "2026",
    skills: [
      "Go",
      "Docker",
          ...
          <div className="flex flex-col gap-2" style={{ height: "420px" }}>
            {visibleProjects.map((project, index) => {
              ...
              return (
                ...
                >
                  {/* ── Full content layer (hidden when compressed) ── */}
                  <div
                  ...
                  {/* ── Compressed layer (title centered) ── */}
                  <div
