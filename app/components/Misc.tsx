      ...
      <div className="flex flex-col items-center gap-6 mb-12">
        <div className="flex flex-col items-center gap-3 opacity-50">
          <div className="flex items-center gap-2">
            ...
            <div
              className="w-2 h-2 rounded-full bg-[var(--accent-amber)] animate-pulse"
              style={{ animationDelay: "0.3s" }}
            />
            <div
              className="w-2 h-2 rounded-full bg-[var(--accent-lavender)] animate-pulse"
              ...
              <div className="relative z-10">
                <h3 className="font-serif text-3xl text-[var(--foreground)] mb-6 flex items-center gap-3">
                  <span
                    ...
                    style={{
                      backgroundColor: accentColors[activeCategory.accent],
                    }}
                  />
