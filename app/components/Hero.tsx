            ...
            <section className="flex flex-col lg:flex-row justify-between items-start w-full gap-12 lg:gap-16">
                ...
                <aside className="flex gap-6 lg:gap-10 w-full lg:w-auto">
                    <div className="flex flex-col gap-6 md:gap-8 lg:pl-8 lg:border-l lg:border-[var(--border-pencil)]">
                        <div>
                            <h3 className="font-mono text-xs tracking-widest text-[var(--accent-water)] uppercase mb-2">
                                Current Role
                            </h3>
                        ...
                        <div>
                            ...
                            <p className="font-sans text-[var(--text-muted)] text-sm leading-relaxed max-w-xs">
                                Distributed systems patterns, SRE tools and methodology,
                                domain-driven architecture
                            </p>
                        </div>

                        <div>
                            <h3 className="font-mono text-xs tracking-widest text-[var(--accent-lavender)] uppercase mb-2">
                                Learning for Joy
                            </h3>
